...
if (isset($_POST['add'])) {
  ...
  $authorfirst = $_POST['author_FN'];
  $authorlast = $_POST['author_LN'];
  $authorbday = $_POST['author_birthday'];
  $authornat = $_POST['author_nat'];

  $authorID = $con->addAuthor($authorfirst, $authorlast, $authorbday, $authornat);
